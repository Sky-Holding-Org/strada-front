...
const NewLaunchCard = React.forwardRef<HTMLDivElement, CompoundCardProps>(
  ({ compound, className, ...props }, ref) => {
    ...
    return (
      <motion.div
        ref={ref}
        className={cn(
          "w-full overflow-hidden rounded-xl bg-white shadow-lg hover:shadow-xl transition-shadow",
          className
        )}
...
NewLaunchCard.displayName = "NewLaunchCard";

export { NewLaunchCard };
