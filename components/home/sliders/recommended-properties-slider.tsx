...
import { RecommendedPropertyCard } from "@/components/home/card/recommended-properties-card";
        ...
        >
          <CarouselContent className="gap-2 sm:gap-3 md:gap-4 lg:gap-5">
            {properties.map((property) => (
              <CarouselItem
                key={property.id}
                className="basis-full xs:basis-1/2 sm:basis-1/3 lg:basis-1/3 xl:basis-1/3"
              >
                <RecommendedPropertyCard propertyItem={property} />
              </CarouselItem>
            ))}
          </CarouselContent>
        </Carousel>
