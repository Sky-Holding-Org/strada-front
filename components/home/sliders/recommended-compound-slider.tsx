...
import { RecommendedCompound } from "@/components/home/card/recommended-compound-card";
...
export function RecommendedCompoundsSlider({
  compounds,
  title = "Top Compounds",
  description = "Discover our recommended projects",
  className,
  variant = "default",
  showAllLink,
}: NewLaunchesSliderProps) {
          ...
          <CarouselContent className="gap-2 sm:gap-3 md:gap-4 lg:gap-5">
            {displayedCompounds.map((compound) => (
              <CarouselItem
                ...
                className={cn(
                  isCompact
                    ? "basis-1/2 xs:basis-1/2 sm:basis-1/3 md:basis-1/4 lg:basis-1/5"
